"""
    numerical_ilu_k_simple!(L::SparseMatrixCSC, U::SparseMatrixCSC, shift::Real=0.0)

Simple, unoptimized but clear implementation of numerical ILU(k) factorization.
This version prioritizes correctness and clarity over performance.
...
"""
function numerical_ilu_k_simple!(
    L::SparseMatrixCSC{T},
    U::SparseMatrixCSC{T},
    shift::Real=T(0)
) where {T}
